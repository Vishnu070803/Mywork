 ...
 *
 * This driver is based on the 2.6.3 version of drivers/usb/usb-keyeton.c
...
#include <asm/page.h>
#include <linux/mm.h>      // for virt_to_phys()
      


/* Define these values to match your devices */
#define USB_KEY_VENDOR_ID	0x413c
#define USB_KEY_PRODUCT_ID	0x2113
...
//	struct semaphore	limit_sem;		/* limiting the number of writes in progress */
	...
	__u8 			interrupt_in_Interval;		/* Interval to poll periodically */
...
{	//phys_addr_t pa;
	...
	int retval;
	pr_info("Entered into my usb device:\n");
...
//	dev->interrupt_out_endpointAddr = interrupt_out->bEndpointAddress;
	...
	dev_info(&interface->dev,
		 "USB Keyboard device now attached to USBKey-%d",
		 interface->minor);
	return 0;
